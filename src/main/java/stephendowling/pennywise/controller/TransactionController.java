...
@RestController
@RequestMapping("/api/transactions") //end point 
public class TransactionController {
    ...
    //get transaction by transaction ID so user can choose CRUD method 
    @GetMapping("/{transactionId}") //http://localhost:8080/api/{transactionId} 
